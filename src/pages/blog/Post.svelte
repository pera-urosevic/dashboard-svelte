<script lang="ts">
  ...
  import { Category, Template, type PostObject, type PostRecord } from '@pages/blog/types'
  import { parsePostRecord } from '@pages/blog/parse'
  import { apiPost, apiPostRemove, apiPostScrape, apiPostUpdate } from '@pages/blog/api'
